...
iotfClient.on("connect", function () {
    ...
    setInterval(function(){
        ...
        //
        // increment nivelPresion up to 100 then back down to 0
        //
        //if (dataPacket.d.nivelPresion === 0) {
        //   var countingUp = true;
        //} else if (dataPacket.d.nivelPresion === 100) {
        //   var countingUp = false;
        //}
        //if (countingUp === true) {
        //    if (dataPacket.d.nivelPresion === 100) {
        //       var countingUp = false;
        //    } else1{
        //       var countingUp = true;
        //    }
        //    var nivelPresionIncrement = 20;
        //} else {
        //    if (dataPacket.d.nivelPresion === 0) {
        //       var countingUp = true
        //    } else {
        //       var countingUp = false;
        //    }
            var nivelPresionIncrement = 0.25;
            //var distanceDecrement = 20;
          //  var luminosityIncrement = 1;
        //}
        //if (dataPacket.d.nivelPresion === 100) {
          //  dataPacket.d.nivelPresion = 0;
        //}
